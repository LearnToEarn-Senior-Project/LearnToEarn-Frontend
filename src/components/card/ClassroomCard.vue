<template>
  ...
  >
    ...
    >
      <div class="truncate w-full mr-2">SE-Za007</div>
      <div class="flex items-center gap-[12px]"><Member /> <span>2</span></div>
    </div>
    <div
      class="px-[15px] py-[10px] text-[14px] flex items-center font-semibold"
    >
      <div>By: Chartchai Duangsa-ard</div>
    </div>
    <div class="h-[20px]"></div>
    <div
      class="text-[14px] flex items-center font-semibold justify-end text-primary-500"
    >
